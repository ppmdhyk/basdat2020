<div class="row" style="width: 100%">
    <div class="col-md-5" style="padding-top:0.5%">
        <div class="row">
            ...
            <div class="col-md-6" style="text-align:center; padding-top:10px">
                <div style="font-family: Roboto;font-style: normal;font-weight: bold;font-size: 36px;line-height: 42px;padding-bottom: 10px;color: #000000;word-spacing: 1px;">S I Q R I N G</div>
                <span style="font-family: Roboto;font-style: normal;font-weight: bold;font-size: 10px;line-height: 4px;color: #000000;">SISTEM PENJURIAN SQL BERBASIS DARING</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-2" style="padding-top:1.2%; text-align:center">
        <a href="<?= site_url('auth/logout') ?>" class="pagelogout"><span style="font-family: Roboto;font-style: normal;font-weight: bold;font-size: 18px;line-height: 21px;color: #FFFFFF;">Keluar</span></a>
    </div>
</div>
