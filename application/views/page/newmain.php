    ...
    <tbody style="font-family: Roboto; font-style: normal;font-weight: bold; font-size: 14px; line-height: 20px;border-color: #FFFFFF">
        ...
        <tr>
            ...
            <td style="text-align: center">
                ...
                ?>
                <span class="label label-<?= $ok_css ?>" style="font-family: Roboto;font-style: normal;width: 100px; border: 1px solid #DEDEDE;box-sizing: border-box;border-radius: 20px;color: #FFFFFF;">Benar</span>
                <span class="label label-<?= $nok_css ?>" style="font-family: Roboto;font-style: normal;width: 100px; border: 1px solid #DEDEDE;box-sizing: border-box;border-radius: 20px;color: #FFFFFF;">Salah</span>
